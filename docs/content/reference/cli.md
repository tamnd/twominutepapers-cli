...
```
twominutepapers <command> [arguments] [flags]
```

Run `twominutepapers <command> --help` for the full flag list on any command. This
...
per operation you declare in `twominutepapers/domain.go`.
