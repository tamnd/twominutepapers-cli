...
// HTTP behaviour is covered in twominutepapers_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "twominutepapers://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("twominutepapers", "about")
	if err != nil || got.String() != "twominutepapers://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want twominutepapers://page/about", got.String(), err)
	}
}
