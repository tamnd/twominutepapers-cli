// Package cli assembles the twominutepapers command tree from the twominutepapers
...
// NewApp assembles the kit application from the twominutepapers domain. The
...
//
// To add a command, declare it in twominutepapers/domain.go with kit.Handle and it
// appears here automatically. Reach for app.AddCommand only for a verb that does
// not fit the emit-records shape, the way version does below.
func NewApp() *kit.App {
	id := twominutepapers.Domain{}.Info().Identity
	id.Version = Version

	app := kit.New(id)
	(twominutepapers.Domain{}).Register(app)
